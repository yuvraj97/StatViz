...
document.cookie = `notDesktop=${check}; path=/;SameSite=Lax`

function quantmlCreateAttributeDiv(id,attr){
    div = document.createElement('div')
    div.id=id
    for (let word of Object.keys(attr)) {
        div.setAttribute(word,attr[word])
    }
